...
def parse_args():
    ...
    parser.add_argument('--rot_scal', default=0.45, type=float, help="sensible schedule [0.05, 0.6]")
    ...
    parser.add_argument('--t_mlp_dim', default=1024, type=int, help="dimension of the mlp layer")
