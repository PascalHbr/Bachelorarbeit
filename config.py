...
def parse_args():
    ...
    parser.add_argument('--L_mu', default=0.5, type=float, help="")
    parser.add_argument('--L_cov', default=1.0, type=float, help="")
    parser.add_argument('--L_rec', default=1.0, type=float, help="")
    parser.add_argument('--L_sep', default=0.5, type=float, help="")
    parser.add_argument('--L_conc', default=0.01, type=float, help="")
    ...
    parser.add_argument('--tps_scal', default=0.0, type=float, help="sensible schedule [0.01, 0.08]")
    parser.add_argument('--rot_scal', default=0.4, type=float, help="sensible schedule [0.05, 0.6]")
    parser.add_argument('--off_scal', default=0.0, type=float, help="sensible schedule [0.05, 0.15]")
    parser.add_argument('--scal_var', default=0.0, type=float, help="sensible schedule [0.05, 0.2]")
    parser.add_argument('--augm_scal', default=1., type=float, help="sensible schedule [0.0, 1.]")

    # appearance parameters
    parser.add_argument('--contrast', default=0.4, type=float,  help="contrast variation")
    parser.add_argument('--brightness', default=0.3, type=float, help="brightness variation")
    parser.add_argument('--saturation', default=0.2, type=float, help="saturation variation")
